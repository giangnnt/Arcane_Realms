...
namespace Assets.Script
{
	public class CharacterMoveBox : Singleton<CharacterMoveBox>
	{
		...
		public void TryPushBox(Vector2 pushDirection)
		{
			...
			Vector3 currentPositionOfCharacter = PlayerController.Instance.transform.position;
			Debug.Log("Current character position: " + currentPositionOfCharacter);
			...
			if (pushDirection.x == 0 && pushDirection.y == 1)
			{
				targetCellOfCharacter = currentCellOfCharacter;
			}
